...
const dailyOpenClose = (apiKey, apiBase, symbol, date, query) => __awaiter(void 0, void 0, void 0, function* () { return (0, request_1.get)(`/v1/open-close/${symbol}/${date}`, apiKey, apiBase, query); });
